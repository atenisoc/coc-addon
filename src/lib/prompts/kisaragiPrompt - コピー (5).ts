...
- 影を見た: ${flags.has_seen_shadow ? 'はい' : 'いいえ'}
- 囁きを聞いた: ${flags.has_heard_whisper ? 'はい' : 'いいえ'}
- 負傷: ${flags.injured ? 'あり' : 'なし'}
- 懐中電灯: ${flags.has_flashlight ? '所持' : 'なし'}
- 出口の方角: ${flags.knows_exit_direction ? '把握済み' : '不明'}
- 尾行者あり: ${flags.is_followed ? 'はい' : 'なし'}
- ループ回数: ${flags.loop_count ?? 0}
